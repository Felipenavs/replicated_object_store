...
class ObjectStoreHandler(BaseHTTPRequestHandler):
    ...
    def _handle_list(self):
        ...
        try:
            ...
            entries = [{"key": entry.key, "size_bytes":entry.size_bytes} for entry in resp.entries]
    ...
    def _handle_stats(self):
        ...
        try:
            res = self._read_stub().Stats(empty_pb2.Empty())
            stats = {"live_objects":res.live_objects, 
